...
class DiffScintilla(QsciScintilla):
    ...
    def apply_diff_markers(self):
        ...
        # Marker 1 = insert (green), 2 = delete (red), 3 = replace (yellow)
        self.setMarkerBackgroundColor(Qt.GlobalColor.green, 1)
        self.setMarkerBackgroundColor(Qt.GlobalColor.red, 2)
        self.setMarkerBackgroundColor(Qt.GlobalColor.yellow, 3)
